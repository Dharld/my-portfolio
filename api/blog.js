/**
 * Blog posts, sourced live from a Google Doc.
 *
...
const DOC_ID = process.env.BLOG_DOC_ID || '1ZrfOCDgMxeYIR4HM6UKhIkYd6nLGaggImcnZDb6zzHo';
const EXPORT_URL = (id) => `https://docs.google.com/document/d/${id}/export?format=html`;

export default async function handler(req, res) {
  res.setHeader('Access-Control-Allow-Origin', process.env.CORS_ALLOW_ORIGIN || '*');

  // A refresh request bypasses the CDN so "I just edited the doc" shows up now.
